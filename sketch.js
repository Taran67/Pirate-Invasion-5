...
var boat_spritesheet;
var broken_boat_animation = [];
var broken_boat_sprite_data;
var broken_boat_spritesheet;
...
function preload() {
  ...
  broken_boat_sprite_data = loadJSON("./assets/boat/broken_boat.json")
  broken_boat_spritesheet = loadImage("./assets/boat/broken_boat.png")
...
function setup() {
  ...
  var boatFrames=boat_sprite_data.frames;
  ...
  for (let i = 0; i < broken_boat_frames.length; i++) {
